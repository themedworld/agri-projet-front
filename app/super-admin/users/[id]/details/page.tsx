  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        // Vérification rôle
        if (![UserRole.MEMBER, UserRole.SUPER_ADMIN].includes(data.role)) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Informations complètes du compte</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-slate-800">
                {user.role === UserRole.SUPER_ADMIN ? "Super Admin" : "Client"}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className={`font-medium ${user.isActive ? "text-emerald-700" : "text-rose-700"}`}>
